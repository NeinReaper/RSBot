...
public class Attributes {
	...
	public final static Area DOCK_AREA = new Area(new Tile[] {
			new Tile(2596, 3418, 0), new Tile(2596, 3426, 0),
			new Tile(2607, 3426, 0), new Tile(2607, 3418, 0) }),
			BANK_AREA = new Area(new Tile[] { new Tile(2581, 3425, 0),
					new Tile(2588, 3425, 0), new Tile(2588, 3417, 0),
					new Tile(2581, 3417, 0) });
	...
	public final static Tile[] BANKING_PATH = { new Tile(2601, 3421, 0),
